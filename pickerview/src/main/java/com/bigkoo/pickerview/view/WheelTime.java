...
public class WheelTime {
    ...
    private static final String DEFAULT_PART = "8点之前";
    ...
    private String part = DEFAULT_PART;
    ...
    public WheelTime(View view, boolean[] type, int gravity, int textSize,List<String> partList) {
        super();
        this.view = view;
        this.type = type;
    ...
    public void setPicker(int year, int month, int day) {
        this.setPicker(year, month, day, 0, 0, 0,"8点之前");
    }

    public void setPicker(int year, final int month, int day, int h, int m, int s,String part) {
        if (isLunarCalendar) {
            int[] lunar = LunarCalendar.solarToLunar(year, month + 1, day);
            setLunar(lunar[0], lunar[1] - 1, lunar[2], lunar[3] == 1, h, m, s,part);
        } else {
            setSolar(year, month, day, h, m, s,part);
        }
    }
     ...
     * @param s
     */
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s,String part) {
        // 年
        ...
        //时间段
        wv_part = (WheelView) view.findViewById(R.id.part);
        wv_part.setAdapter(new ArrayWheelAdapter(partList));
        wv_part.setCurrentItem(0);
        wv_part.setGravity(gravity);
        ...
        setChangedListener(wv_part);

        if (type.length != 7) {
            throw new RuntimeException("type[] length is not 7");
        }
        ...
        wv_part.setVisibility(type[6] ? View.VISIBLE : View.GONE);
        setContentTextSize();
    }
     ...
     * @param s
     */
    private void setSolar(int year, final int month, int day, int h, int m, int s,String part) {
...
//                maxItem = endD;
    ...
    private void setContentTextSize() {
        ...
        wv_part.setTextSize(textSize);
    }


    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds,String label_part) {
        if (isLunarCalendar) {
            return;
        }
        ...
        if (label_part != null) {
            wv_part.setLabel(label_part);
        } else {
            wv_part.setLabel(view.getContext().getString(R.string.pickerview_part));
        }
    }

    public void setTextXOffset(int x_offset_year, int x_offset_month, int x_offset_day,
                               int x_offset_hours, int x_offset_minutes, int x_offset_seconds,int x_offset_part) {
        ...
        wv_part.setTextXOffset(x_offset_part);
    }
           ...
           /* int i = wv_month.getCurrentItem() + startMonth;
            ...
            if ((wv_month.getCurrentItem() + startMonth) == startMonth) {
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                        ...
                        .append(wv_seconds.getCurrentItem()).append(" ")
                        .append(wv_part.getCurrentItem());
            } else {
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                        .append((wv_month.getCurrentItem() + startMonth)).append("-")
    ...
    public Integer getPart() {
        return Integer.valueOf(wv_part.getCurrentItem());
    }
    ...
    public void setLineSpacingMultiplier(float lineSpacingMultiplier) {
        ...
        wv_part.setLineSpacingMultiplier(lineSpacingMultiplier);
    }
    ...
    public void setDividerColor(int dividerColor) {
        ...
        wv_part.setDividerColor(dividerColor);
    }
    ...
    public void setDividerType(WheelView.DividerType dividerType) {
        ...
        wv_part.setDividerType(dividerType);
    }
    ...
    public void setTextColorCenter(int textColorCenter) {
        ...
        wv_part.setTextColorCenter(textColorCenter);
    }
    ...
    public void setTextColorOut(int textColorOut) {
        ...
        wv_part.setTextColorOut(textColorOut);
    }
    ...
    public void isCenterLabel(boolean isCenterLabel) {
        ...
        wv_part.isCenterLabel(isCenterLabel);
    }
    ...
    public void setItemsVisible(int itemsVisibleCount) {
        ...
        wv_part.setItemsVisibleCount(itemsVisibleCount);
    }
    ...
    public void setAlphaGradient(boolean isAlphaGradient) {
        ...
        wv_part.setAlphaGradient(isAlphaGradient);
    }
