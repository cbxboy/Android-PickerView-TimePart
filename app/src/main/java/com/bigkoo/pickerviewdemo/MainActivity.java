...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initLunarPicker() {
        ...
        pvCustomLunar = new TimePickerBuilder(this, new OnTimeSelectListener() {
            @Override
            public void onTimeSelect(Date date,int part, View v) {//选中事件回调
                Toast.makeText(MainActivity.this, getTime(date) + part, Toast.LENGTH_SHORT).show();
            }
        })
    ...
    private void initTimePicker() {//Dialog 模式下，在底部弹出
        pvTime = new TimePickerBuilder(this, new OnTimeSelectListener() {
            @Override
            public void onTimeSelect(Date date,int part, View v) {
                Toast.makeText(MainActivity.this, getTime(date) + part, Toast.LENGTH_SHORT).show();
                ...
                .setType(new boolean[]{true, true, true, true, true, true,true})
    ...
    private void initCustomTimePicker() {
        ...
        pvCustomTime = new TimePickerBuilder(this, new OnTimeSelectListener() {
            @Override
            public void onTimeSelect(Date date,int part, View v) {//选中事件回调
                btn_CustomTime.setText(getTime(date) + part);
            }
        })
               ...
               /*.setDividerColor(Color.WHITE)//设置分割线的颜色
                ...
                .setContentTextSize(18)
                .setType(new boolean[]{false, false, false, true, true, true,true})
                .setLabel("年", "月", "日", "时", "分", "秒","时间段")
                .setLineSpacingMultiplier(1.2f)
                .setTextXOffset(0, 0, 0, 40, 0, -40,0)
                .isCenterLabel(false) //是否只显示中间选中项的label文字，false则每项item全部都带有label。
